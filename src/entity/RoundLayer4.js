//第四关
var RoundLayer4 = cc.Layer.extend({
	_name:"round4",
	_obs1:null,
	_obs2:null,
	_obsCount:2,
...
RoundLayer4.create = function() {
	if (cc.pool.hasObject(RoundLayer4)) {
		return cc.pool.getFromPool(RoundLayer4);
	} else {
		return new RoundLayer4();
	}
}